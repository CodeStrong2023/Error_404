...
if __name__ == "__main__":
    Persona1 = persona2("Lucas", "Basso", 22)
    ...
    # Objeto 1
    Persona2 = persona2("Lara", "Aguero", 21)
    print(Persona2.nombre)
    print(Persona2.apellido)
    print(Persona2.edad)

    Persona2.nombre = "Gonzalo Romero"
    ...
    # Objeto 2
    Persona3 = persona2("Ailin", "Morales", 16)
    ...
    # Objeto 3
    Persona4 = persona2("Maria", "Eugenia", 51)
    print(Persona4.nombre)
    print(Persona4.apellido)
    print(Persona4.edad)

    Persona4.nombre = "Maria Clara"
    Persona4.apellido = "Eugenia"
    Persona4.edad = 51
